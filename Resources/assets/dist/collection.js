...
var _default = /*#__PURE__*/function (_Controller) {
  ...
  _createClass(_default, [{
    ...
    value: function initialize() {
      for (var i = 0; i < this.initialNbElementsValue; i++) {
        this.add();
      }
    }
  }, {
    ...
    value: function add(e) {
      ...
      var itemProto = this.prototypeValue.replace(/__name__label__/g, this.nbElementsValue).replace(/__name__/g, this.nbElementsValue);
    ...
    key: "nbElementsValueChanged",
    value: function nbElementsValueChanged() {
...
_defineProperty(_default, "targets", ['list', 'addBtn']);
